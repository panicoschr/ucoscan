...
<form action="<?php echo JRoute::_('index.php?option=com_ucoscan&layout=edit&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="adminForm" class="form-validate">
	<div class="row-fluid">
		...
		<?php echo JHtml::_('bootstrap.startTabSet', 'myTab', array('active' => 'details')); ?>
			...
			<?php echo JHtml::_('bootstrap.addTab', 'myTab', 'details', empty($this->item->id) ? JText::_('COM_UCOSCAN_NEW_DOMAIN', true) : JText::sprintf('COM_UCOSCAN_EDIT_DOMAIN', $this->item->id, true)); ?>
