...
if ($saveOrder) {
    $saveOrderingUrl = 'index.php?option=com_ucoscan&task=ucoscansites.saveOrderAjax&tmpl=component';
    JHtml::_('sortablelist.sortable', 'ucoscansiteList', 'adminForm', strtolower($listDirn), $saveOrderingUrl);
}
        ...
        <?php else : ?>
            ...
            <div id="filter-bar" class="btn-toolbar">
                <div class="filter-search btn-group pull-left">
                    <label for="filter_search" class="element-invisible"><?php echo JText::_('COM_UCOSCAN_SEARCH_IN_DESCRIPTION_OR_UCOSCANSITE_TYPE'); ?></label>
                    <input type="text" name="filter_search" id="filter_search" placeholder="<?php echo JText::_('COM_UCOSCAN_SEARCH_IN_DESCRIPTION_OR_UCOSCANSITE_TYPE'); ?>" value="<?php echo $this->escape($this->state->get('filter.search')); ?>" title="<?php echo JText::_('COM_UCOSCAN_SEARCH_IN_DESCRIPTION_OR_UCOSCANSITE_TYPE'); ?>" />
                </div>
