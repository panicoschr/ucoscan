...
if ($user->id == 0) {
    ...
    <form action="<?php echo JRoute::_('index.php?option=com_ucoscan&view=suffixes'); ?>" method="post" name="adminForm" id="adminForm">
        <div class="btn-toolbar">
            <div class="btn-group">
                <button type="button" class="btn btn-primary" onclick="Joomla.submitbutton('suffix.add')">
                    <i class="icon-new"></i> <?php echo JText::_('JNEW') ?>
                </button>
                <button type="button" class="btn btn-primary" onclick="Joomla.submitbutton('suffixes.publish')">
                    <i class="icon-new"></i> <?php echo JText::_('JPUBLISH') ?>
                </button>    
                <button type="button" class="btn btn-primary" onclick="Joomla.submitbutton('suffixes.unpublish')">
